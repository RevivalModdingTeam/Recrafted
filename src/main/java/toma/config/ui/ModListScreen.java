...
public class ModListScreen extends Screen {
        ...
        if (p_mouseClicked_5_ == 0) {
            if (p_mouseClicked_1_ >= 20 && p_mouseClicked_1_ <= 150 && p_mouseClicked_3_ >= 20 && p_mouseClicked_3_ < 20 + displayedEntryAmount * 20) {
                ...
                if (info != null) {
                    ...
                    config.active = selected != null && (Config.configs().get(selected.getModId()) != null || ConfigGuiHandler.getGuiFactoryFor(selected).isPresent());
    ...
    protected void openConfig() {
        ...
        if (object != null) {
            minecraft.displayGuiScreen(new ModConfigScreen(object, selected, this));
        } else {
